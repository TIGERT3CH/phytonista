...
print(f"Preço: R$\{preco:.2f}")  # R$19.99</pre>`,
          exercises: [
            ...
            },
            {
              ...
              template: 'idade = 20\n# Crie a f-string',
              expected: null,
              validate: (output) => output.includes("20") && output.toLowerCase().includes("tenho"),
...
print(texto[::-1])  # nohtyP (invertido)</pre>`,
          exercises: [
            ...
            },
            {
              ...
              template: 'texto = "Python"\n# Inverta a string',
              expected: null,
              validate: (output) => output.trim() === "nohtyP",
...
print(pares)  # [0, 2, 4, 6, 8]</pre>`,
          exercises: [
            ...
            },
            {
              ...
              expected: null,
              validate: (output) => output.trim().replace(/[\[\],\s]/g, '\n').split('\n').filter(Boolean).join('\n') === "0\n1\n8\n27\n64",
...
pessoa["email"] = "ana@email.com"</pre>`,
          exercises: [
            ...
            },
            {
              ...
              expected: null,
              validate: (output) => output.trim() === "Maria",
...
print(resultado)  # 8</pre>`,
          exercises: [
            ...
            },
            {
              ...
              expected: null,
              validate: (output) => output.trim() === "10",
    ...
    print("Sempre executa!")</pre>`,
          exercises: [
            ...
            },
            {
              ...
              expected: null,
              validate: (output) => output.toLowerCase().includes("erro") || output.length > 0,
...
print(os.listdir("."))</pre>`,
          exercises: [
            ...
            },
            {
              ...
              expected: null,
              validate: (output) => output.trim() === "2026",
